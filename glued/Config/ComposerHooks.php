...
class ComposerHooks
{
    ...
    public static function getSettings(): array {
        ...
        // ammend with user defined configs
        $files = glob($refs['env']['datapath'] . '/*/config/*.yaml');
        foreach ($files as $file) {
            $yaml = file_get_contents($file);
            $arr = $class_sy->parse($yaml, $class_sy::PARSE_CONSTANT);
            $array = array_merge($array, $arr);
        }
        // Replace yaml references with $_ENV and $seed ($_ENV has precedence)
